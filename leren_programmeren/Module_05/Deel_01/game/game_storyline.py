...
"1": """You are the best trained commander of an army. You have been at war with your enemy for many years, and your king is done with it. 
...
"2": """You and your team chose the forest. But in the forest they have to choose another route.
One leads to the swamp, and the other one to the elf village.
Choose wich path to go: swamp or elf village? """,

"3": """You enter the elf village, and the elfs greet you politely.    
They offer you some supplies for a very low price. But you don't really wanna pay.
What will you do: buy or steal? """,

"4": """You steal the supplies and run. The elfs don't like thiefs. They shoot 5 men in their leg.
...
"7": """You enter the mine, and the path is pretty dangerous.
...
"8": """You all start yelling at the troll. It gets scared, and runs away.
You continue the path, and come across a wall full off gold ores.
Will you mine it? (type 'yes' or 'no') """,

"9": """You start running from the troll. But he takes bigger steps so it catches up.
It punches 6 men, and they don't survive.
You continue the path, and come across a wall full off gold ores.
Will you mine it? (type 'yes' or 'no') """,

"10": """You don't have enough money. The guards won't let you in.
...
"11": """You and your team choose the village.
...
"12": """You steal the axe and run. The villagers get really mad and out of anger they trap 3 of your men.
You want to save them but you don't know if you should.
What will you do? Save of continue: """,

"13": """You know you can't save them, so you just move along.
...
"14": """You ask if it can be made cheaper, but the shopkeeper tells you that the axe is the only one ever made and that they won't make it cheaper.
...
"15": """You ask the guards if you can get past, but they say no.
But you really have to get past.
What will you do? threaten or tell who you sent (just type 'tell'): """,

"16": """The guards accept it and open the gate for you.
...
"17": """"You run away, but the badits shoot 5 men with their crossbows straight in the neck.
...
"18": """Because you are all better trained and better equipped, you managed to defeat the bandits.
You walk up a hill and see the enemy castle in the distance. Waving the letter around, you walk towards it.
But at the gate stand some guards, who are not happy.
How can you be let in? Choose ask or threaten: """,

"19": """You mined the gold. You put it in your bags and continue the journey.
...
"20": """You mined the gold. You put it in your bags and continue the journey.
You and your team walk to the exit of the cave, and end up on the other side.
You see the enemy castle in the distance. Waving the letter around, you walk towards it.
But at the gate stand some guards, who are not happy.
How can you be let in? Choose ask or threaten: """,

"21": """You didn't mine the gold.
You and your team walk to the exit of the cave, and end up on the other side.
You see the enemy castle in the distance. Waving the letter around, you walk towards it.
But at the gate stand some guards, who are not happy.
How can you be let in? Choose ask or threaten: """,

"22": """You have nothing to mine the gold with.
You and your team walk to the exit of the cave, and end up on the other side.
You see the enemy castle in the distance. Waving the letter around, you walk towards it.
But at the gate stand some guards, who are not happy.
How can you be let in? Choose ask or threaten: """
